...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        int enteredHitPoints = myScan.nextInt();
        while (enteredHitPoints > 50 || enteredHitPoints < 1) {
            System.out.println("Sorry. Hit points must be between 1 and 50: ");
            enteredHitPoints = myScan.nextInt();
        }
        tempPokemon.hitPoints = enteredHitPoints;

        System.out.println("Split fifty points between attack level and defense level");
        System.out.print("Enter your attack level: ");
        int enteredAttackPoints = myScan.nextInt();
        while (enteredAttackPoints > 49 || enteredAttackPoints < 1) {
            System.out.print("Sorry. The attack level must be between 1 and 49: ");
            enteredAttackPoints = myScan.nextInt();
        }
        tempPokemon.attackLevel = enteredAttackPoints;
        System.out.print("Enter your defense level: ");
        int enteredDefensePoints = myScan.nextInt();
        while (enteredDefensePoints > 50 - enteredAttackPoints || enteredDefensePoints < 1) {
            System.out.print("Sorry. The defense level must be between 1 and " + (50 - enteredAttackPoints) + ": ");
            enteredDefensePoints = myScan.nextInt();
        }
        tempPokemon.attackLevel = enteredAttackPoints;
